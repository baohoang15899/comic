...
protocol ChapterDetailRoutes {
    func navigateExample1()
}

class ChapterDetailCoordinator: Coordinator {
...
//        exampleVC.bind(to: ExampleViewModel())
//        navigator.pushViewController(exampleVC, animated: true)
    }
}

// logic các phương thức điều hướng
extension ChapterDetailCoordinator: ChapterDetailRoutes {
